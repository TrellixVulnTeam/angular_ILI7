...
export class MyblogComponent implements OnInit {
  ...
  openModalDialogCustomClass(content) {
    ...
    const modalRef = this.modalService.open(EditblogsComponent, { size: 'lg',backdrop:false});

    (<EditblogsComponent>modalRef.componentInstance).dataToTakeAsInput = content;
